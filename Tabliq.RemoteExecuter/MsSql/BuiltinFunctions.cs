...
{
    public static List<FunctionSymbol> functions = new List<FunctionSymbol>
    {
        // https://learn.microsoft.com/en-us/sql/t-sql/functions/date-bucket-transact-sql?view=sql-server-ver17
        new FunctionSymbol( "DATE_BUCKET", IsAggregate: false,
        [
        ...
        new FunctionSymbol( "DATEADD", IsAggregate: false,
        [
            new FunctionArgumentSymbol("datepart", BinderHandling: BinderHandling.Skip), // datepart symbol.
        ...
        new FunctionSymbol("DATEDIFF", IsAggregate: false,
        [
            new FunctionArgumentSymbol("datepart", BinderHandling: BinderHandling.Skip), // datepart symbol.
        ...
        new FunctionSymbol("DATEDIFF_BIG", IsAggregate: false,
        [
            new FunctionArgumentSymbol("datepart", BinderHandling: BinderHandling.Skip), // datepart symbol.
                new FunctionArgumentSymbol("startDate"), // date expression
                new FunctionArgumentSymbol("endDate") // date expression
        ...
        new FunctionSymbol( "DATEFROMPARTS", IsAggregate: false,
        [
        ...
        new FunctionSymbol( "DATETIME2FROMPARTS", IsAggregate: false,
        [
            new FunctionArgumentSymbol("year"), // year expression
            new FunctionArgumentSymbol("month"), // month expression
            new FunctionArgumentSymbol("day"), // day expression
        ...
        new FunctionSymbol( "DATETIMEFROMPARTS", IsAggregate: false,
        [
            new FunctionArgumentSymbol("year"), // year expression
            new FunctionArgumentSymbol("month"), // month expression
            new FunctionArgumentSymbol("day"), // day expression
        ...
        new FunctionSymbol( "DATETIMEOFFSETFROMPARTS", IsAggregate: false,
        [
            new FunctionArgumentSymbol("year"), // year expression
            new FunctionArgumentSymbol("month"), // month expression
            new FunctionArgumentSymbol("day"), // day expression
        ...
        new FunctionSymbol( "DATETRUNC", IsAggregate: false,
        [
            new FunctionArgumentSymbol("datepart", BinderHandling: BinderHandling.Skip), // datepart symbol.
            new FunctionArgumentSymbol("date") // date expression
        ]),
        ...
        new FunctionSymbol( "SMALLDATETIMEFROMPARTS", IsAggregate: false,
        [
            new FunctionArgumentSymbol("year"), // year expression
            new FunctionArgumentSymbol("month"), // month expression
            new FunctionArgumentSymbol("day"), // day expression
        ...
        new FunctionSymbol( "SWITCHOFFSET", IsAggregate: false,
        [
        ...
        new FunctionSymbol( "TIMEFROMPARTS", IsAggregate: false,
        [
            new FunctionArgumentSymbol("hour"), // hour expression
            new FunctionArgumentSymbol("minute"), // minute expression
            new FunctionArgumentSymbol("second"), // second expression
        ...
        new FunctionSymbol( "TODATETIMEOFFSET ", IsAggregate: false,
        [
            new FunctionArgumentSymbol("datetimeoffset_expression"), // datetimeoffset expression
            new FunctionArgumentSymbol("timezoneoffset_expression"), // timezoneoffset expression
        ]),
        ...
        new FunctionSymbol("COUNT_BIG", IsAggregate: true, [
        ...
        new FunctionSymbol("FIRST_VALUE", IsAggregate: true, [
        ...
        new FunctionSymbol("LAG", IsAggregate: true, [
        ...
        new FunctionSymbol("PERCENTILE_DISC ", IsAggregate: true, [
            new FunctionArgumentSymbol("numeric_literal"),
        ]),
        ...
        new FunctionSymbol("CONVERT", IsAggregate: false, [
        ...
        new FunctionSymbol("CONCAT", IsAggregate: false,
        [
        ...
        new FunctionSymbol("CONCAT_WS", IsAggregate: false,
        [
